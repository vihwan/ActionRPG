    ...
    public class ScreenshotHandler : MonoBehaviour
    {
       ...
       // FighterGeneration fighterGeneration;
        private void Awake()
        {
           ...
           // fighterGeneration = FindObjectOfType<FighterGeneration>();
        ...
        public IEnumerator onPostRender()
        {
            ...
            if (takeScreenshotOnNextFrame)
            {
              ...
              //  System.IO.File.WriteAllBytes(fighterGeneration.GetFileName() + ".png", byteArray);
                RenderTexture.ReleaseTemporary(renderTexture);
                myCamera.targetTexture = null;
              //  Debug.Log(fighterGeneration.GetFileName() + ".png created");
            }
        }
